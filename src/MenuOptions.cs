...
public class MenuOptions
{
    ...
    private void UpdateHtml()
    {
        ...
        _availableChars =
            (int)(Menu.MENU_LENGTH / ((int)ItemFontSize * 0.6))
            - Selector[0].Value.Length
            - Selector[1].Value.Length;
    }

    public MenuValue[] Cursor = [new("►", new Color().Rainbow()), new("◄", new Color().Rainbow())];
