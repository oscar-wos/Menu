...
public class Example : BasePlugin
{
    ...
    public override void Load(bool isReload)
    {
        AddCommand("css_test", "", (controller, _) =>
        {
            ...
            var itemPlayersPinwheel = new MenuItem(MenuItemType.Button, new ButtonValue("button: ", ButtonType.Search), players, true);
            ...
            var itemCustomButtons = new MenuItem(MenuItemType.Button, new MenuValue("buttons: "), customButtons);
            ...
            Menu.SetMenu(controller, mainMenu, (buttons, menu, item) =>
            {
                ...
                var menuValue = item.Values![item.Option];
                var data = item.Data[item.Option];
                var dataString = item.DataString;
                ...
                if (menu.Option == 4)
                {
                    var buttonValue = (ButtonValue)menuValue;
    ...
    private void CustomSelectMethod(CCSPlayerController controller)
    {
